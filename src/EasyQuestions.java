public class EasyQuestions
{
	...
	{
		/*String quest8 = "73167176531330624919225119674426574742355349194934"
	...
	//*1000 digit number commented out in main*
	//Find the thirteen adjacent digits in the 1000-digit number that 
	//have the greatest product. What is the value of this product?
	//---------------------------------------------------------------
	public static long largeProdinSeries(String num, int numDigits)
	{
		long max = 0;
		for(int i = 0; i + numDigits< num.length(); i++)
		{
			long total = 1;
			int count = 0;
			for(int j = i; count < numDigits; j++)
			{
				total *= Integer.parseInt(num.charAt(j) + "");
				count++;
			}
	...
	//-------------------------------------------------------------------------------
	public static long specialPythTriplet()
	{
		for(int a = 1; a < 500; a++)
			for(int b = 1; b < 500; b++)
			{
	...
	//-------------------------------------------------------------
	public static long sumPrimes(int cap)
	{
		long total = 5;
